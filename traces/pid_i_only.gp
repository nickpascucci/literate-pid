    ...
    plot "traces/pid_i_only.csv" using 1:3 with lines ls 102
    
    set title "System State"
    set ylabel "Temperature"
    set ytics scale 0.5 1
    plot "traces/pid_i_only.csv" using 1:2 with lines ls 101
    
    set title "Control"
    set ylabel "Flow Rate"
    set ytics scale 0.5 100
    plot "traces/pid_i_only.csv" using 1:4 with lines ls 103
