    ...
    plot "traces/runaway.csv" using 1:3 with lines ls 102
    
    set title "System State"
    set ylabel "Temperature"
    plot "traces/runaway.csv" using 1:2 with lines ls 101
    
    set title "Control"
    set ylabel "Flow Rate"
    plot "traces/runaway.csv" using 1:4 with lines ls 103
